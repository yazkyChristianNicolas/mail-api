package ar.com.yazkychristian.mailapi.rest;
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(final MethodArgumentNotValidException ex, final HttpHeaders headers, final HttpStatus status, final WebRequest request) {
        ...
        final ApiError apiError = new ApiError(HttpStatus.BAD_REQUEST, "Invalid Request, missing or invalid params.", errors);
    ...
    public ResponseEntity<Object> handleResponseStatusException(final ResponseStatusException ex, final WebRequest request) {
        final ApiError apiError = new ApiError(ex.getStatus(), ex.getReason(), "");
        return new ResponseEntity<Object>(apiError, new HttpHeaders(), apiError.getStatus());
    }
}
